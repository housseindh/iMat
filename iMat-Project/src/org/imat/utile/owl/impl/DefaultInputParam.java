 ...
 * Source Class: DefaultInputParam <br>
 * @version generated on Mon Apr 27 04:17:47 EEST 2015 by lenovo
 */
public class DefaultInputParam extends WrappedIndividualImpl implements InputParam {

    public DefaultInputParam(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends MethodCall> getIsInputTo() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_ISINPUTTO,
                                               DefaultMethodCall.class);
    }

    public boolean hasIsInputTo() {
	   return !getIsInputTo().isEmpty();
    }

    public void addIsInputTo(MethodCall newIsInputTo) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_ISINPUTTO,
                                       newIsInputTo);
    }

    public void removeIsInputTo(MethodCall oldIsInputTo) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_ISINPUTTO,
                                          oldIsInputTo);
    }
